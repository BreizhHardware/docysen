...
/**
 * Retourne une copie du body avec les champs sensibles masqués, pour le logging uniquement.
 * Ne modifie jamais request.body : les credentials restent utilisables par le handler,
 * simplement invisibles dans les logs/erreurs.
 */
