...
/**
 * Queue BullMQ "tagging" : job produit par api-service (à l'approbation d'un document et/ou
 * à la complétion de l'OCR si le document est déjà approuvé), consommé par tagging-worker.
 * Le texte OCR est passé directement dans le job (pas de download S3) car il est déjà en mémoire.
 * ocrText peut être null si l'OCR n'a pas encore terminé au moment de l'approbation.
 */
