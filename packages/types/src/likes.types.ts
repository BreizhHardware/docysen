...
/**
 * GET /likes : documents likés en détail, pas seulement leurs IDs. Un document liké puis
 * rejeté/supprimé n'apparaît plus ici, comme pour /search qui n'index que les documents approuvés.
 */
